...
| Base URL | `http://localhost:5173` locally (`vite dev`); **CI** uses preview on `http://localhost:4173` after `pnpm turbo build` |
| Admin base | `http://localhost:5174` locally; **CI** preview on `http://localhost:4174` |
