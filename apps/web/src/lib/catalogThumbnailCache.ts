...
export const CATALOG_THUMBNAIL_WARM_LIMIT = 40;

function isImageDecoded(img: HTMLImageElement | undefined): boolean {
...
export function warmCatalogThumbnails(
  urls: readonly string[],
  limit = CATALOG_THUMBNAIL_WARM_LIMIT,
): void {
  let count = 0;
